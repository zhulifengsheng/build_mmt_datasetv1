...
def annotation_without_image(request, index_without_image):
    ...
    if total_amount_without_image < index_without_image or user_obj.now_index_without_image < index_without_image:
        index = min(user_obj.now_index_without_image, total_amount_without_image)
    ...
    res = {
        ...
        'zh1': zh1,
        'zh2': zh2,
        'total':get_total_amount_without_image(user_obj),   # 总共需要标注的个数
